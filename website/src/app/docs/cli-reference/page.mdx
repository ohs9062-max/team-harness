...
Options:
  ...
  --agents TEXT               Comma-separated allowlist (e.g. "codex,antigravity")
...
- **Agent emojis** — each agent type shows a per-type emoji (e.g. 🔷 codex, 🚀 antigravity, 🟣 claude) in the agent panel and event log.
