...
- **Workers** are external CLI processes — `codex`, `claude`, `agy`, and the others — that do the actual work. The coordinator spawns them as subprocesses and reads their output.
